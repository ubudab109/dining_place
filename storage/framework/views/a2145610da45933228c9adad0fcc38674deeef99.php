        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row gx-2 gx-lg-3 mb-2">
                    <div class="col-9">
                        <h4><i class="tio-chart-bar-4"></i><?php echo e(__('order_texts.dashboard_order_statistics')); ?></h4>
                    </div>
                    <div class="col-3">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/diningtest/resources/views/admin-views/dashboard.blade.php ENDPATH**/ ?>