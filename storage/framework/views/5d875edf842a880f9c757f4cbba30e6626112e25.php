                ...
                <div class="row no-gutters">
                    <div class="col-lg-12 col-md-6">
                        <div class="form-wizard">
                            <form action="<?php echo e(url('subcription/free-reg')); ?>" method="post" role="form">
                                <?php echo csrf_field(); ?>
                                ...
                                <fieldset class="wizard-fieldset show">
                                    <h5>Account Information</h5>
                                        <div class="form-group">
                                            <label class="input-label label-cus" for="name"><?php echo e(__('messages.restaurant')); ?> <?php echo e(__('messages.name')); ?></label><span class="text-red">*</span>
                                            <input type="text" name="restaurant_name" id="restaurant_name" class="form-control wizard-required" placeholder="<?php echo e(__('messages.first')); ?> <?php echo e(__('messages.name')); ?>" value="<?php echo e(old('name')); ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="input-label label-cus" for="address"><?php echo e(__('messages.restaurant')); ?> <?php echo e(__('messages.address')); ?></label><span class="text-red">*</span>
                                            <textarea type="text" name="address" id="address_res" class="form-control wizard-required" placeholder="<?php echo e(__('messages.restaurant')); ?> <?php echo e(__('messages.address')); ?>" required ><?php echo e(old('address')); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="input-label label-cus" for="address"><?php echo e(__('messages.vat/tax')); ?> (%)</label><span class="text-red">*</span>
                                            <input type="number" name="tax" id="tax" class="form-control wizard-required" placeholder="<?php echo e(__('messages.vat/tax')); ?>" min="0" step=".01" required value="<?php echo e(old('tax')); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="input-label label-cus"><?php echo e(__('messages.restaurant')); ?> <?php echo e(__('messages.logo')); ?><small style="color: red"> ( <?php echo e(__('messages.ratio')); ?> 1:1 )</small></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    <label class="label-cus" for="name"><?php echo e(__('messages.upload')); ?> <?php echo e(__('messages.cover')); ?> <?php echo e(__('messages.photo')); ?> <span class="text-danger">(<?php echo e(__('messages.ratio')); ?> 2:1)</span></label>
                                                    <div class="custom-file">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            <label class="input-label label-cus" for="f_name"><?php echo e(__('messages.first')); ?> <?php echo e(__('messages.name')); ?><span class="text-red">*</span></label>
                                                            <input type="text" name="f_name" id="f_name" class="form-control wizard-required" placeholder="<?php echo e(__('messages.first')); ?> <?php echo e(__('messages.name')); ?>"
                                                                value="<?php echo e(old('f_name')); ?>"  required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            <label class="input-label label-cus" for="l_name"><?php echo e(__('messages.last')); ?> <?php echo e(__('messages.name')); ?><span class="text-red">*</span></label>
                                                            <input type="text" name="l_name" id="l_name" class="form-control wizard-required" placeholder="<?php echo e(__('messages.last')); ?> <?php echo e(__('messages.name')); ?>"
                                                            value="<?php echo e(old('l_name')); ?>"  required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            <label class="input-label label-cus" for="phone"><?php echo e(__('messages.phone')); ?><span class="text-red">*</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            <label class="input-label label-cus" for="email"><?php echo e(__('messages.email')); ?><span class="text-red">*</span></label>
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="categories[]" id="categories" class="form-control js-select2-custom wizard-required" multiple="multiple">
                                                                <?php $__currentLoopData = \App\Models\RestaurantType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <fieldset class="wizard-fieldset">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-<?php echo e(!$subscription->is_free ? '6' : '12'); ?>">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <td><?php echo e($subscription->subs_name); ?></td>
                                                    <td>Rp. <?php echo e(number_format($subscription->subs_price, 0)); ?></td>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        <th>Total</th>
                                                        <td>
                                                            <strong>Rp. <?php echo e(number_format($subscription->subs_price, 0)); ?></strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        ...
                                                        <?php else: ?>
                                                        <input type="hidden" name="externalId" id="externalId" value="<?php echo e(uniqid('SUBS')); ?>">
                                                        <input type="hidden" name="price" id="restaurant_price" value="0">
                                                        <input type="hidden" name="status" id="status" value="COMPLETED">
                                                        <?php endif; ?>

                                                        <input type="hidden" name="subsId" id="subsId" value="<?php echo e($subscription->id); ?>">
                                                        <?php if(!$subscription->is_free): ?>
                                                ...
                                                <div class="card" style="width: 74%;">
                                                    <div class="card-body">
                                                        <div class="form-check">
                                                            ...
                                                            <span><img src="<?php echo e(asset('assets/bank/${data.code}.png')); ?>" style=" margin-left: 0.3em;
                                                                max-height: 23px;
