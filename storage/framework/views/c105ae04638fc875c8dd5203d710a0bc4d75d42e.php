...
<div class="card-header">
    <h5 class="card-header-title">
        <i class="tio-medal"></i> <?php echo e(trans('messages.top_restaurants')); ?>
                ...
                <?php $__currentLoopData = $top_restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr onclick="location.href='<?php echo e(route('admin.vendor.view', $item->restaurant_id)); ?>'"
                        ...
                        <td scope="row">
                            ...
                            <span class="ml-2">
                                                       <?php echo e($item->restaurant->name??'Not exist!'); ?>
...
<!-- End Body -->
<?php /**PATH /home/vagrant/code/diningtest/resources/views/admin-views/partials/_top-restaurants.blade.php ENDPATH**/ ?>