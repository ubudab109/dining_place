        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> <?php echo e(__('messages.add')); ?> <?php echo e(__('messages.new')); ?> <?php echo e(__('messages.food')); ?></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="available_time_starts" class="form-control" value="<?php echo e($opening_time); ?>" min="<?php echo e($opening_time); ?>"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="available_time_ends" class="form-control" value="<?php echo e($closing_time); ?>" max="<?php echo e($closing_time); ?>"  placeholder="5:45 pm"
                                       required>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        $('#food_form').on('submit', function () {
            ...
            $.post({
                url: '<?php echo e(route('vendor.food.store')); ?>',
                data: $('#food_form').serialize(),
                data: formData,
                cache: false,
                contentType: false,
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/diningtest/resources/views/vendor-views/product/index.blade.php ENDPATH**/ ?>