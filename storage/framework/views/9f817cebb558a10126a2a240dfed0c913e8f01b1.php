                ...
                <div class="row gx-2 gx-lg-3 mb-2">
                    <div class="col-9">
                        <h4><i style="font-size: 30px"
                               class="tio-chart-bar-4"></i>Report Statistics</h4>
                    </div>
                    <div class="col-3">
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        function order_stats_update(type) {
            ...
            $.post({
                url: '<?php echo e(route('vendor.report.order-stats')); ?>',
                data: {
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/diningtest/resources/views/vendor-views/report/index.blade.php ENDPATH**/ ?>