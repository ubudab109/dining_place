        ...
        <div class="row align-items-sm-center w-100">
            ...
            <div class="col-sm-6 col-md-4 text-center text-sm-left">
                ...
                <?php if(auth('vendor')->check()): ?>
                    <a class="btn btn-primary" href="<?php echo e(route('vendor.dashboard')); ?>">Dashboard</a>
                <?php else: ?>
...
<?php /**PATH /home/vagrant/code/diningtest/resources/views/errors/404.blade.php ENDPATH**/ ?>