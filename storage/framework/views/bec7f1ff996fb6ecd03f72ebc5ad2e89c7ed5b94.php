        ...
        <div class="card-body row">
            ...
            <div class="for-card col-md-6 mb-1">
                <div class="card for-card-body-2 shadow h-100 text-white" style="background: #f9fafc; font-weight: 20px; color: #818283 !important;">
                    ...
                    <div class="card-footer"  style="background: #f9fafc; border:none;">
                      <a tabindex="0" class="btn btn w-100 btn-pink" role="button" data-toggle="popover" data-trigger="focus" title="<?php echo e(__('messages.warning_missing_bank_info')); ?>" data-content="<?php echo e(__('messages.warning_add_bank_info')); ?>">Cancel Subscription</a>
                    </div>
                </div>
            </div>
            ...
            <div class="for-card col-md-6 mb-1">
                <div class="card for-card-body-2 shadow h-100 text-white" style="background: #f9fafc; font-weight: 20px; color: #818283 !important;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div
                                    class="for-card-count">Payment Date : <?php echo e(date('j F Y', strtotime($resSubs->updated_at))); ?>

                                </div>
                                <div
                                    class="for-card-count">Pay With: <?php echo e($resSubs->payment_type == 'Xendit' ? 'Online Payment VA' : 'Bank Transfer'); ?>
                    ...
                    <div class="card-footer"  style="background: #f9fafc; border:none;">
                      <a tabindex="0" target="_blank" href="<?php echo e(route('vendor.print-invoice')); ?>" class="btn btn w-100 btn-pink" role="button" data-toggle="popover" data-trigger="focus" title="<?php echo e(__('messages.warning_missing_bank_info')); ?>" data-content="<?php echo e(__('messages.warning_add_bank_info')); ?>">Print Invoice</a>
                    </div>
                </div>
            </div>
        </div>
