                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4"><?php echo e(__('messages.restaurant')); ?> <?php echo e(__('messages.sign_in')); ?></h1>
                        ...
                        <!-- Form -->
                        <form class="js-validate" action="<?php echo e(route('vendor.auth.login')); ?>" method="post" id="vendor_login_form" style="display: none;">
                            <?php echo csrf_field(); ?>
                            <!-- Form Group -->
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4"><?php echo e(__('messages.restaurant_owner_login_form')); ?></span>
                                </div>
                            </div>
                        ...
                        <!-- End Form -->
                        <!-- Form -->
                        <form class="js-validate" action="<?php echo e(route('vendor.auth.employee.login')); ?>" method="post" id="employee_login_form" style="display: none;">
                            <?php echo csrf_field(); ?>
                            <div class="text-center">
                                <div class="m-2">
...
<?php /**PATH /home/vagrant/code/diningtest/resources/views/vendor-views/auth/login.blade.php ENDPATH**/ ?>