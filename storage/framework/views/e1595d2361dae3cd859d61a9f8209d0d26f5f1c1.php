        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="<?php echo e(asset('storage/app/public/vendor')); ?>/<?php echo e(auth('vendor')->user()->image); ?>"
                                 alt="Image">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           ...
                                           value="<?php echo e(auth('vendor')->user()->phone); ?>"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           value="<?php echo e(auth('vendor')->user()->email); ?>"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="<?php echo e(env('APP_MODE')!='demo'?route('vendor.profile.settings-password'):'javascript:'); ?>" method="post"
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/diningtest/resources/views/vendor-views/profile/index.blade.php ENDPATH**/ ?>