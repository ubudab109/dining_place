            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Notification <?php echo e(__('messages.list')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($notifications->count()); ?></span></h5>
                        ...
                        <div class="table-responsive datatable-custom">
                            <table id="columnSearchDatatable"
                                ...
                                <tbody id="table-div">
                                  ...
                                  <?php else: ?>
                                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($key+$notifications->firstItem()); ?></td>
                                            <td><?php echo e($notif->id); ?></td>
                                            <td>
                                            <span class="d-block font-size-sm text-body">
                                                <?php echo e($notif['data']); ?>
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/diningtest/resources/views/vendor-views/notification/index.blade.php ENDPATH**/ ?>