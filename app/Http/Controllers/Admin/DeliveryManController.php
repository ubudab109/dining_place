...
class DeliveryManController extends Controller
{
    ...
    public function reviews_list(){
        $reviews=DMReview::with(['delivery_man','customer'])->latest()->paginate(25);
    ...
    public function preview($id, $tab='info')
    {
        ...
        if($tab == 'info')
        {
            $reviews=DMReview::where(['delivery_man_id'=>$id])->latest()->paginate(25);
            return view('admin-views.delivery-man.view.info', compact('dm', 'reviews'));
        }
        else if($tab == 'transaction')
        {
            return view('admin-views.delivery-man.view.transaction', compact('dm'));
        }        
    }
