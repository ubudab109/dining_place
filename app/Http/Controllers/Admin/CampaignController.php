...
class CampaignController extends Controller
{
    ...
    function list($type)
    {
        if($type=='basic')
        {
            ...
            $campaigns=ItemCampaign::latest()->paginate(25);
        }
    ...
    {   
        ...
        {
            $campaign = Campaign::findOrFail($campaign);
            $restaurants = $campaign->restaurants()->paginate(25);
            $restaurant_ids = []; 
    ...
    public function status($type, $id, $status)
    {
        ...
        $campaign->save();
        Toastr::success('Campaign status updated!');
        return back();
    }
    ...
    public function delete(Campaign $campaign)
    {
        ...
        $campaign->delete();
        Toastr::success('Campaign removed!');
        return back();
    }
