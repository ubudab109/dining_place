...
class VendorController extends Controller
{
    public function get_profile(Request $request)
    {
        ...
        $vendor['todays_earning'] =(float)$vendor->todays_earning()->sum('original_delivery_charge');
        $vendor['this_week_earning'] =(float)$vendor->this_week_earning()->sum('original_delivery_charge');
        $vendor['this_month_earning'] =(float)$vendor->this_month_earning()->sum('original_delivery_charge');
