            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{__('messages.campaign')}} {{__('messages.list')}}</h5>
                        <form id="search-form">
                            @csrf
                            <!-- Search -->
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($campaigns as $key=>$campaign)
                                <tr>
                                    ...
                                    <td>
                                        <span class="d-block text-body"><a href="{{route('admin.campaign.view',['item',$campaign->id])}}">{{$campaign['title']}}</a>
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="bg-gradient-light text-dark">{{$campaign->start_time?$campaign->start_time->format('h:i:sa'). ' - ' .$campaign->end_time->format('h:i:sa'): 'N/A'}}</span>
                                    </td>
