        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-pink" href="{{route('vendor.dashboard')}}">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('vendor-settings-form','Want to update owner info ?')":"call_demo()"}}" class="btn btn-pink">Save changes</button>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','Want to update admin password ?')":"call_demo()"}}" class="btn btn-pink">Save Changes</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
