        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> List {{__('messages.coupon')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('vendor.coupon.create')}}" class="btn btn-pink">Add Coupon</a>
                    </div>
                    <!-- Table -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="#" onclick="detail({{$coupon['id']}})" data-toggle="modal" data-target="#detail_modal">Detail</a>
                                              <a class="dropdown-item" href="#" onclick="destroy({{$coupon['id']}})">Delete</a>
                                            </div>
                                          </div>
                                    </td>
                                </tr>
...
<script>
    function detail(id)
    {
        var url = '{{ route("vendor.coupon.show", ":id") }}';
    ...
    function destroy(id)
    {
        var url = '{{ route("vendor.coupon.delete", ":id") }}';
        url = url.replace(':id', id);
        Swal.fire({
