      ...
      <div class="col-md-12">
          <div class="card">
              <div class="card-header">
                  <h1 class="h3 mb-0 text-capitalize">{{__('messages.edit')}} {{__('messages.restaurant')}} Address</h1>
              </div>
              <div class="card-body">
                <p>Current Address: {{$shop->address}}</p>

                  <form action="{{route('vendor.shop.update-address',[$shop->id])}}" method="post"
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="name">Street 2<span class="text-white">Optional</span></label>
